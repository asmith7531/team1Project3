        ...
        <div class="card blue-grey darken-1">
          <div class="card-content white-text">
            ...
            <p className="flow-text">
              ...
              They are also sometimes responsible for typesetting, illustration,
              user interfaces, and web design. A core responsibility of the
              designer's job is to present information in a way that is both
